...
///
/// Shared cards stay neutral unless a screen explicitly uses the featured
/// surface signature. The signature is intentionally narrow so one dashboard
/// card cannot change the appearance of unrelated ERP cards.
class AppCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isFeatured =
        ...
        (color == colors.featuredMiddle || color == theme.colorScheme.secondaryContainer);
