...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = (
            "id", "customer", "created_by", "coupon", "coupon_discount",
            "status", "subtotal", "total", "paid_amount", "outstanding_amount",
            "sold_quantity", "items", "created_at", "updated_at",
        )
        read_only_fields = (
            "id", "created_by", "coupon_discount", "status", "subtotal", "total",
            "paid_amount", "outstanding_amount", "sold_quantity", "created_at", "updated_at",
        )
...
class InvoiceSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "total", "paid_amount", "outstanding_amount", "sold_quantity", "created_at", "updated_at",
        )
